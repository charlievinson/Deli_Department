...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    string trackingSelectionLabel = "Tracking Information: " + currentProductCode;
...

    {
        ...
        HWND inventoryButton = CreateWindow(
            L"BUTTON",  // Predefined class; Unicode assumed 
            L"Inventory",      // Button text 
            ...
            100,        // Button height
            hWnd,     // Parent window
            (HMENU)INVENTORY_BUTTON,       // No menu.
            (HINSTANCE)GetWindowLongPtr(hWnd, GWLP_HINSTANCE),
            NULL);      // Pointer not needed.

        HWND editButton = CreateWindow(
            L"BUTTON",  // Predefined class; Unicode assumed 
            L"Edit",      // Button text 
            WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON,  // Styles 
            825,         // x position 
    ...
    case WM_PAINT:
        ...
        TextOut(hdc,
            50, 440,
            L"Use By Date:", _tcslen(L"Use By Date:"));
        ...
        TextOut(hdc,
            450, 360,
            startingWeightSzFull, _tcslen(startingWeightSzFull));

        TextOut(hdc,
            450, 440,
            useByDateSzFull, _tcslen(useByDateSzFull));
